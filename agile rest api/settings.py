"""
Django settings for agile rest api project.
...
ROOT_URLCONF = 'agile rest api.urls'
...
WSGI_APPLICATION = 'agile rest api.wsgi.application'
...
GRAPHENE = {
    ...
    'SCHEMA': 'agile rest api.schema.schema'
}
